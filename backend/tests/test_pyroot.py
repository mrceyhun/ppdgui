...
class TestPyroot:
    ...
    def test_get_root_dirs_or_hist(self):
        ...
        # th1f json
        r1 = pyroot.get_root_dirs_or_hist(TEST_BIG_ROOT_FILE,
                                          "DQMData/Run 366713/EcalPreshower/Run summary/ESRecoSummary/recHits_ES_energyMax")
        # None, because it requires full obj path
        r2 = pyroot.get_root_dirs_or_hist(TEST_BIG_ROOT_FILE, "recHits_ES_energyMax")

        r3 = pyroot.get_root_dirs_or_hist(TEST_BIG_ROOT_FILE, "DQMData/Run 366713")

        # dirs
        r4 = pyroot.get_root_dirs_or_hist(TEST_BIG_ROOT_FILE, "DQMData/")

        assert r1.hist_json[0]['_typename'] == pyroot.RootClasses.TH1F
