...
<template>
  <section class="p-0 px-0 " :class="[containerMaxW, !(hasTriggeredToUpdate || hasUpdated) ? 'opacity-25' : '']">

    <!--  LOADING ANIMATION-->
    <div v-if="!hasTriggeredToUpdate" role="status"
      class="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2">
      <svg aria-hidden="true" class="w-20 h-20 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
